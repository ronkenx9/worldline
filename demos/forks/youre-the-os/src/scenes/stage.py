...
class Stage(Scene):
    ...
    def __init__(self, name: str, config : StageConfig,
        ...
        self._worldline_store = WorldlineStore()
        self._worldline_labels = []
        self._worldline_run_recorded = False
        self._worldline_outcome_recorded = False
    ...
    def setup(self):
        ...
        # No WORLDLINE overlay during gameplay. The briefing lives on the title
        # (before play) and the post-run summary (after play). Events still record.
        self._worldline_labels = []
    ...
    @property
    def worldline_store(self):
        return self._worldline_store
    ...
    def on_start(self):
        ...
        """
        if not self._worldline_run_recorded:
            self._worldline_store.record_run_start(self.name)
            self._worldline_run_recorded = True
    ...
    def on_victory(self):
        ...
        """
        self._record_worldline_outcome('victory')
    ...
    def on_defeat(self):
        ...
        """
        self._record_worldline_outcome('defeat')
    ...
    def _record_worldline_outcome(self, outcome):
        if self._worldline_outcome_recorded:
            return
        self._worldline_store.record_run_end(
            stage_name=self.name,
            score=self._score_manager.score,
            outcome=outcome,
        )
        self._worldline_outcome_recorded = True
